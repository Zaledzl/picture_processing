...
def get_inputs(s):  # s为图像路径
    ...
    glcm = greycomatrix(
        input, [2, 8, 16], [0, np.pi/4,np.pi/2,np.pi*3/4], 256, symmetric=True, normed=True)
...
if __name__ == '__main__':
    get_inputs("D:\\picture processing\\The positive and negative samples\\impurity1\\1.jpg")
